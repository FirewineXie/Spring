 ...
 * @Program Name: <br>
 * @Create : 2018-11-27-16:50
 * @Description :  <br/>
 */
@SessionAttributes(value = {"user"}, types = {String.class})
/*
 1. 如果存在SessionAttribute 里面有会话的user，，必须在类里面就要有   @ModelAttribute
    不然会报错
 */
...
public class SpringMVCTest {
    ...
    /**
     * 如果返回的字符串中带forward：或redirect ： 前缀时，SpringMVC会对他们进行特殊处理，将这两个为当成
     * 指示符，后面的字符串作为URL来处理
     *
     * @return
     */
    ...
    /**
     * 1.有@ModelAttribute 标记的方法， 会在每个目标方法之前被SpringMVc 调用
     * 2.@ModelAtribute 注解也可以来修饰目标方法POJO 类型的入参，其value属性值有如下的作用
    ...
    public void getUser(@RequestParam(value = "id" , required = false) Integer id,
        ...
        if (id != null){
            User user= new User(1,"Tom","123456","Tom@12.com",12);
    ...
    public String testSessionAttributes(Map<String , Object> map){
        ...
        map.put("user",user);
        map.put("school","xiexiexie");
        return SUCCESS;
    }
    /**
     * 目标方法可以添加Map(实际上也可以是Model 类型 或 ModelMap 类型)的参数
     * @param map
     * @return
     */
     ...
     *
     */
//    在使用ModelAndView返回视图时可能后台不报任何错误，但是就是不能解析到对应的jsp页面。这时候有可能是包引入错误:
//
...
//import org.springframework.web.servlet.ModelAndView;--正确的包
    ...
    /**
     * @PathVariable 可以来映射URL中的占位符到目标方法的参数汇总
     * @param id
     * @return
     */
    ...
    /**
     * 了解 ； 可以使用params 和headers 来更加精确的映射请求，，params 和header 支持简单的表达式
     * @return
     */
     ...
     * 相对于 WEB 应用的根目录
     */
    @RequestMapping("/testtestRequestMapping")
